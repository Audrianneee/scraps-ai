...
type Step = "welcome" | "ingredients" | "preferences" | "results" | "chat";
...
const Index = () => {
  ...
  const handleIngredientsComplete = (ings: Ingredient[], equip: string[]) => {
    setIngredients(ings);
    setEquipment(equip);
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6 text-center animate-fade-in">
            ...
            <div className="flex flex-wrap justify-center gap-8 mb-12">
              <div className="flex items-center gap-2">
                ...
                <span className="text-foreground/70">AI-Powered Recipes</span>
              </div>
              <div className="flex items-center gap-2">
                <Clock className="w-5 h-5 text-primary" />
                <span className="text-foreground/70">Custom Time Ranges</span>
              </div>
              <div className="flex items-center gap-2">
                <Flame className="w-5 h-5 text-primary" />
                <span className="text-foreground/70">Calorie Tracking</span>
              </div>
              <div className="flex items-center gap-2">
                <UtensilsCrossed className="w-5 h-5 text-primary" />
                <span className="text-foreground/70">Multiple Cuisines</span>
              </div>
            </div>
